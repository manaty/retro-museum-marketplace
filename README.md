...
Version 0.1 reviews source (up to 220,000 characters) and up to six images. It explicitly records truncated source, unreviewed images/audio and lack of interactive playthrough. **This initial version always requires a human check before publication**, even when AI findings are favorable. It does not claim store certification, complete security auditing, proven asset ownership or automated gameplay coverage. The current service is the creator/review/catalog foundation; hosted multiplayer rooms and museum installation UI are separate integration work.
